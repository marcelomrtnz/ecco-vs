...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-porcelain/95 backdrop-blur-sm supports-[backdrop-filter]:bg-porcelain/80" suppressHydrationWarning>
