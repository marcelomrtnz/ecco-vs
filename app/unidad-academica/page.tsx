...
const SLUG = 'unidad-academica-unah-vs-elecciones-2026'

export const metadata: Metadata = {
  title: 'Junta Directiva de Unidad Academica - Elecciones UNAH 2026 - ECCO',
  description:
    'Candidatos y propuestas de ECCO para la Junta Directiva de Unidad Academica en las elecciones estudiantiles UNAH 2026. UNAH-VS Valle de Sula.',
  alternates: { canonical: 'https://ecco-vs.com/unidad-academica' },
}

export default function UnidadAcademicaPage() {
  const carrera = getCarrera(SLUG)!
  const breadcrumbItems = [
    { name: 'Inicio', url: '/' },
    { name: 'Unidad Academica', url: '/unidad-academica' },
  ]
      ...
      <div className="mx-auto max-w-4xl px-4 py-8 md:px-6 md:py-12">
        ...
        <div className="mt-8 flex flex-col gap-2">
          <h1 className="text-balance text-3xl font-bold text-charcoal md:text-4xl">
            Junta Directiva de Unidad Academica
        ...
        <div className="mt-14">
          <ProposalsList
            ...
            carreraNombre="Unidad Academica"
          />
        </div>
